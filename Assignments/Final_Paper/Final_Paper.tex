...
\usepackage[version=3]{mhchem}  %Chemistry fonts
...
A MPCVD process was studied to analyze the optimization methodology with real observations from a real experiment. The process takes place in a chamber where different gases (\ce{H_2}, \ce{CH_4}, \ce{O_2}, \ce{N_2} and \ce{Ar}) with different concentrations turn into plasma in order to build graphene structures over a copper foil. In this procedure, the Raman spectrum of the foil is used to analyze vibrational properties of the layers of graphene that are deposited from the process. The G/D ratio observed in this spectrum is a variable to be maximized.
